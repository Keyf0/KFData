...
//typedef zzz_SIZE zzz_SIZE;

//typedef zzz_BOOL BOOL;
static const zzz_BOOL True = 1;
static const zzz_BOOL False = 0;
...
static inline zzz_BOOL ParseFast(Value *v, const char *s)
{
    return zzz_ValueParseFast(v, s);
}
static inline zzz_BOOL ParseLen(Value *v, const char *s, zzz_SIZE len)
{
    return zzz_ValueParseLen(v, s, len);
}
static inline zzz_BOOL Parse(Value *v, const char *s)
{
...
static inline const char *GetStrFast(const Value *v, zzz_SIZE *len)
{
...
static inline const zzz_BOOL *GetBool(const Value *v)
{
    return zzz_ValueGetBool(v);
}
static inline zzz_BOOL IsNull(const Value *v)
{
...
static inline const char *GetKeyFast(const Value *v, zzz_SIZE *len)
{
...
static inline Value *ObjGetLen(const Value *v, const char *key, zzz_SIZE len)
{
...
static inline zzz_SIZE zzzSize(const Value *v)
{
    return zzz_ValueSize(v);
}
static inline Value *ArrayGet(const Value *v, zzz_SIZE index)
{
...
static inline zzz_BOOL Move(Value *v)
{
    return zzz_ValueMove(v);
}
static inline zzz_BOOL SetNull(Value *v)
{
    return zzz_ValueSetNull(v);
}
static inline zzz_BOOL SetBool(Value *v, zzz_BOOL b)
{
    return zzz_ValueSetBool(v, b);
}
static inline zzz_BOOL SetNumStrFast(Value *v, const char *num)
{
    return zzz_ValueSetNumStrFast(v, num);
}
static inline zzz_BOOL SetNumStrLenFast(Value *v, const char *num, zzz_SIZE len)
{
    return zzz_ValueSetNumStrLenFast(v, num, len);
}
static inline zzz_BOOL SetNumStr(Value *v, const char *num)
{
    return zzz_ValueSetNumStr(v, num);
}
static inline zzz_BOOL SetNumStrLen(Value *v, const char *num, zzz_SIZE len)
{
    return zzz_ValueSetNumStrLen(v, num, len);
}
static inline zzz_BOOL SetNum(Value *v, const double d)
{
    return zzz_ValueSetNum(v, d);
}
static inline zzz_BOOL SetDouble(Value *v, const double d)
{
    return zzz_ValueSetDouble(v, d);
}
static inline zzz_BOOL SetInt(Value *v, const int d)
{
    return zzz_ValueSetInt(v, d);
}
static inline zzz_BOOL SetLong(Value *v, const long d)
{
    return zzz_ValueSetLong(v, d);
}
static inline zzz_BOOL SetLongLong(Value *v, const long long d)
{
    return zzz_ValueSetLongLong(v, d);
}
static inline zzz_BOOL SetStrFast(Value *v, const char *str)
{
    return zzz_ValueSetStrFast(v, str);
}
static inline zzz_BOOL SetStrLenFast(Value *v, const char *str, zzz_SIZE len)
{
    return zzz_ValueSetStrLenFast(v, str, len);
}
static inline zzz_BOOL SetStr(Value *v, const char *str)
{
    return zzz_ValueSetStr(v, str);
}
static inline zzz_BOOL SetStrLen(Value *v, const char *str, zzz_SIZE len)
{
    return zzz_ValueSetStrLen(v, str, len);
}
static inline zzz_BOOL SetStrEscape(Value *v, const char *str)
{
    return zzz_ValueSetStrEscape(v, str);
}
static inline zzz_BOOL SetStrLenEscape(Value *v, const char *str, zzz_SIZE len)
{
    return zzz_ValueSetStrLenEscape(v, str, len);
}
static inline zzz_BOOL SetKeyFast(Value *v, const char *key)
{
    return zzz_ValueSetKeyFast(v, key);
}
static inline zzz_BOOL SetKeyLenFast(Value *v, const char *key, zzz_SIZE len)
{
    return zzz_ValueSetKeyLenFast(v, key, len);
}
static inline zzz_BOOL SetKey(Value *v, const char *key)
{
    return zzz_ValueSetKey(v, key);
}
static inline zzz_BOOL SetKeyLen(Value *v, const char *key, zzz_SIZE len)
{
    return zzz_ValueSetKeyLen(v, key, len);
}
static inline zzz_BOOL SetKeyEscape(Value *v, const char *key)
{
    return zzz_ValueSetKeyEscape(v, key);
}
static inline zzz_BOOL SetKeyLenEscape(Value *v, const char *key, zzz_SIZE len)
{
    return zzz_ValueSetKeyLenEscape(v, key, len);
}
static inline zzz_BOOL SetArray(Value *v)
{
    return zzz_ValueSetArray(v);
}
static inline zzz_BOOL SetObj(Value *v)
{
    return zzz_ValueSetObj(v);
}
static inline zzz_BOOL SetFast(Value *v, Value *vv)
{
    return zzz_ValueSetFast(v, vv);
}
static inline zzz_BOOL Set(Value *v, const Value *vv)
{
    return zzz_ValueSet(v, vv);
}
static inline zzz_BOOL ObjAddFast(Value *v, Value *vv)
{
    return zzz_ValueObjAddFast(v, vv);
}
static inline zzz_BOOL ObjAdd(Value *v, const Value *vv)
{
    return zzz_ValueObjAdd(v, vv);
}
static inline zzz_BOOL ArrayAddFast(Value *v, Value *vv)
{
    return zzz_ValueArrayAddFast(v, vv);
}
static inline zzz_BOOL ArrayAdd(Value *v, const Value *vv)
{
    return zzz_ValueArrayAdd(v, vv);
}
static inline zzz_BOOL ArrayDel(Value *v, zzz_SIZE index)
{
    return zzz_ValueArrayDel(v, index);
}
static inline zzz_BOOL ObjDel(Value *v, const char *key)
{
